...
{
    FStar_UInt128_uint128 res;
    res.low = a.low + b.low,
    res.high = a.high + b.high + FStar_UInt128_carry(a.low + b.low, b.low);
    return res;
}
...
FStar_UInt128_sub(FStar_UInt128_uint128 a, FStar_UInt128_uint128 b)
{
    FStar_UInt128_uint128 res;
    res.low = a.low - b.low;
    res.high = a.high - b.high - FStar_UInt128_carry(a.low, a.low - b.low);
    return res;
}
...
FStar_UInt128_shift_left_small(FStar_UInt128_uint128 a, uint32_t s)
{
    if (s == (uint32_t)0U)
        ...
        FStar_UInt128_uint128 res;
        res.low = a.low << s;
        res.high = FStar_UInt128_add_u64_shift_left_respec(a.high, a.low, s);
        return res;
    }
}
...
FStar_UInt128_shift_left_large(FStar_UInt128_uint128 a, uint32_t s)
{
    FStar_UInt128_uint128 res;
    res.low = (uint64_t)0U;
    res.high = a.low << (s - FStar_UInt128_u32_64);
    return res;
}
...
FStar_UInt128_shift_right_small(FStar_UInt128_uint128 a, uint32_t s)
{
    if (s == (uint32_t)0U)
        ...
        FStar_UInt128_uint128 res;
        res.low = FStar_UInt128_add_u64_shift_right_respec(a.high, a.low, s);
        res.high = a.high >> s;
        return res;
    }
}
...
{
    FStar_UInt128_uint128 res;
    res.low = a.high >> (s - FStar_UInt128_u32_64);
    res.high = (uint64_t)0U;
    return res;
}
...
{
    FStar_UInt128_uint128 res;
    res.low = FStar_UInt64_eq_mask(a.low, b.low) & FStar_UInt64_eq_mask(a.high, b.high);
    res.high = FStar_UInt64_eq_mask(a.low, b.low) & FStar_UInt64_eq_mask(a.high, b.high);
    return res;
}
...
{
    FStar_UInt128_uint128 res;
    res.low = (FStar_UInt64_gte_mask(a.high, b.high) & ~FStar_UInt64_eq_mask(a.high, b.high)) | (FStar_UInt64_eq_mask(a.high, b.high) & FStar_UInt64_gte_mask(a.low, b.low));
    res.high = (FStar_UInt64_gte_mask(a.high, b.high) & ~FStar_UInt64_eq_mask(a.high, b.high)) | (FStar_UInt64_eq_mask(a.high, b.high) & FStar_UInt64_gte_mask(a.low, b.low));
    return res;
}
...
{
    K___uint64_t_uint64_t_uint64_t_uint64_t res;
    res.fst = FStar_UInt128_u64_mod_32(x);
    res.snd = FStar_UInt128_u64_mod_32(FStar_UInt128_u64_mod_32(x) * FStar_UInt128_u64_mod_32(y));
    res.thd = x >> FStar_UInt128_u32_32;
    res.f3 = (x >> FStar_UInt128_u32_32) * FStar_UInt128_u64_mod_32(y) + (FStar_UInt128_u64_mod_32(x) * FStar_UInt128_u64_mod_32(y) >> FStar_UInt128_u32_32);
    return res;
}
...
FStar_UInt128_mul_wide_impl(uint64_t x, uint64_t y)
{
    ...
    x_ = scrut.thd;
    t_ = scrut.f3;
    res.low = FStar_UInt128_u32_combine_(u1 * (y >> FStar_UInt128_u32_32) + FStar_UInt128_u64_mod_32(t_),
                                              w3);
    res.high = x_ * (y >> FStar_UInt128_u32_32) + (t_ >> FStar_UInt128_u32_32) +
